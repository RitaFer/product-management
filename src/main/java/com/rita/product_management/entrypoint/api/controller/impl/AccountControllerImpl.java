...
public class AccountControllerImpl implements AccountController {
    ...
    @Override
    public ResponseEntity<AccountResponse> updateAccount(@Valid UpdateAccountRequest request) {
    ...
    public ResponseEntity<AccountResponse> findAccount(String id) {
        AccountResponse response = getAccountUseCase.execute(new GetAccountCommand(id));
        return ResponseEntity.ok(response);
    }
